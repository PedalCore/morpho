...
def main():
    ...
    ap.add_argument('--mixed', action='store_true',
                    help='M6: half counters, half delta memory')
    ...
    cfg = Config(vocab_size=tok.vocab_size, n_layer=args.layers,
                 ...
                 mlp=args.mlp,
                 attn='slots' if args.slots else 'mixed' if args.mixed else 'longhorn' if args.longhorn else 'qkv' if args.qkv else 'tssalit' if args.tssalit else 'tost' if args.tost else 'crsa' if args.crsa else 'mssa',
